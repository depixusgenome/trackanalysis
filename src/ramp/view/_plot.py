...
class GuiDataRampProcessor(DataCleaningProcessor):
    "gui data processor"
    @staticmethod
    def canregister():
...
class RampPlotCreator(TaskPlotCreator[DataCleaningModelAccess], WidgetMixin):
    "Building the graph of ramps"
    ...
    def _reset(self):
        'called when when new input file'
