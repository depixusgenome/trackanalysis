...
COLS: FrozenSet[Column] = frozenset({
    ...
    Column('hfsigma',            'y', None, False, True,  False, 'σ[HF] (bp)'),
    ...
    Column('blockageresolution', 'y', None, False, False, False, 'σ[blockage] (bp)'),
    ...
    Column('blockagehfsigma',    'y', None, False, False, False, 'σ[HF] per blockage (bp)'),
