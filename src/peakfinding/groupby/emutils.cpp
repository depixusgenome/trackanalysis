...
OutputPY emrunnner(ndarray pydata, ndarray pyrates, ndarray pyparams,ssize_t nsteps){
...
void pymodule(py::module &mod){
    mod.doc()+="C++ implementation of Expectation Maximization\n";
    mod.def("emrunner",&emrunner,"runs n expectation maximization steps");
}
